...
import cn.gaotianye.javaProject.utils.DateUtils;
import cn.gaotianye.javaProject.utils.StringUtils;
...
public class MockData {
	...
	public static void mock(JavaSparkContext sc,SQLContext sqlContext) {
		...
		String[] searchKeywords = new String[] {"火锅", "蛋糕", "重庆辣子鸡", "重庆小面",
				"呷哺呷哺", "新辣道鱼火锅", "国贸大厦", "太古商场", "日本料理", "温泉","好伦哥",
				"意大利自助餐","吉野家","老城一锅","东来顺","西单大悦城","王府井","北京烤鸭","田园鸡火锅",
				"红烧肉","老灶火锅","农家乐","休闲会所","SPA男士会所","足疗保健","天天美发","天意堂KTV"};
		String date = DateUtils.getTodayDate();
		String[] actions = new String[]{"search", "click", "order", "pay"};
		Random random = new Random();
		/**
		 * 1W个用户，每个用户10个sessionId，每个session操作 0-100个点击事件
		 */
